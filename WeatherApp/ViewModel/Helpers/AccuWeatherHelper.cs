...
namespace WeatherApp.ViewModel.Helpers
{
    class AccuWeatherHelper
    {
        ...
        public const string API_KEY = "Vw55JOd77NDXApZAxfN60Q5q1zBYk9kr";
        public const string LOCATION_KEY = "265318";
        ...
        public static async Task<CurrentConditions> GetCurrentConditions(string locationKey)
        {
            ...
            using (HttpClient client = new HttpClient())
            {
                ...
                currentCondition = (JsonConvert.DeserializeObject<List<CurrentConditions>>(json)).FirstOrDefault();
            }
